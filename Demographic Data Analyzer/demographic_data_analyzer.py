...
def calculate_demographic_data(print_data=True):
    ...
    percentage_bachelors =  round (( len (df['education'] == 'Bachelors') / df.shape[0] ) * 100, 2)
...
round(higher_education[higher_education['salary'] == '>50K']['salary'].count() / higher_education.shape[0] * 100, 1)
